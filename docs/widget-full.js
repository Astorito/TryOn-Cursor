(function() {
  ...
  function createElements() {
    ...
    fab.innerHTML = `<svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="28" cy="28" r="28" fill="#222"/><path d="M50 0 L61 39 L100 50 L61 61 L50 100 L39 61 L0 50 L39 39 Z" fill="#FAF9F3" transform="translate(36, 21) scale(0.272) translate(-50, -50)"/><path d="M50 0 L61 39 L100 50 L61 61 L50 100 L39 61 L0 50 L39 39 Z" fill="#FAF9F3" transform="translate(24, 40) scale(0.152) translate(-50, -50)"/><path d="M50 0 L61 39 L100 50 L61 61 L50 100 L39 61 L0 50 L39 39 Z" fill="#FAF9F3" transform="translate(12, 31) scale(0.096) translate(-50, -50)"/></svg>`;
