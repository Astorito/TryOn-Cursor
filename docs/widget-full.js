(function() {
  ...
  function createElements() {
    ...
    fab.innerHTML = `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 10 L23.5 15 L28 16 L23.5 17 L22 22 L20.5 17 L16 16 L20.5 15 Z" fill="url(#g1)"/><path d="M13 18 L14 21 L17 22 L14 23 L13 26 L12 23 L9 22 L12 21 Z" fill="url(#g2)"/><path d="M15 10 L15.8 12.5 L18 13 L15.8 13.5 L15 16 L14.2 13.5 L12 13 L14.2 12.5 Z" fill="url(#g3)"/><defs><linearGradient id="g1" x1="16" y1="10" x2="28" y2="22" gradientUnits="userSpaceOnUse"><stop stop-color="#FFD04B"/><stop offset="1" stop-color="#FF6B35"/></linearGradient><linearGradient id="g2" x1="9" y1="18" x2="17" y2="26" gradientUnits="userSpaceOnUse"><stop stop-color="#FF8C42"/><stop offset="1" stop-color="#FF4B4B"/></linearGradient><linearGradient id="g3" x1="12" y1="10" x2="18" y2="16" gradientUnits="userSpaceOnUse"><stop stop-color="#FFD04B"/><stop offset="1" stop-color="#FFB347"/></linearGradient></defs></svg>`;
    fab.style.cssText = 'position: fixed; bottom: 24px; right: 24px; background: linear-gradient(135deg, #5b6ee8, #764ba2); color: white; border: none; border-radius: 50%; width: 64px; height: 64px; cursor: pointer; box-shadow: 0 4px 16px rgba(102,126,234,0.45); transition: transform 0.2s, box-shadow 0.2s; pointer-events: auto; display: flex; align-items: center; justify-content: center; padding: 0;';
